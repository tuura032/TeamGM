...
public class PlayerDao {
	...
	private final String GET_PLAYERS_BY_TEAM_ID = "SELECT * FROM players WHERE team_id = ?";
	private final String GET_PLAYER_BY_NAME = "SELECT * FROM players WHERE first_name = ? and last_name = ? limit 1";
	...
	public List<Player> getPlayersByTeamId(int teamId) throws SQLException {
		PreparedStatement ps = connection.prepareStatement(GET_PLAYERS_BY_TEAM_ID);
		ps.setInt(1, teamId);
